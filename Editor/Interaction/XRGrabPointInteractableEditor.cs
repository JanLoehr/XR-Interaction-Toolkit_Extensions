...
{
    [CustomEditor(typeof(XRGrabPointInteractable))]
    internal class XRGrabPointInteractableEditor : Editor
    {
        SerializedProperty m_AttachTransform;
        SerializedProperty _AttachAtContactPoint;
        ...
        static class Tooltips
        {
            ...
            public static readonly GUIContent attachAtContactPoint = new GUIContent("Attach At Contact Point", "If checked the Interactable will be attached to the controller at the contact point.");
        ...
        void OnEnable()
        {
            ...
            _AttachAtContactPoint = serializedObject.FindProperty("_attachAtContactPoint");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_AttachAtContactPoint, Tooltips.attachAtContactPoint);
